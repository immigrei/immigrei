...
export default function PainelClient({ hasAccess }: { hasAccess: boolean }) {
  ...
  // A timeline é o coração do Painel de Jornadas: no plano grátis ela aparece
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mb-7">
          ...
          {hasAccess ? (
            ...
            <PaywallGate
              titulo="Sua jornada completa, passo a passo"
              descricao="Você tem um caminho traçado — cada etapa, na ordem certa, com prazos e o que fazer em cada uma. Assine para destravar o painel inteiro e o cofre de documentos."
            >
              {timeline}
            </PaywallGate>
          )}
        ...
        {/* Guard-rails */}
        {hasAccess && s.guardrails.length > 0 && (
          <div className="mb-7">
