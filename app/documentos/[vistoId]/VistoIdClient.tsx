...
export default function VistoIdClient({ hasAccess }: { hasAccess: boolean }) {
  ...
  useEffect(() => {
    // Plano grátis vê a prévia borrada — não precisa carregar dados reais.
    ...
    <AppShell>
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {hasAccess ? (
          ...
          <PaywallGate
            titulo="Checklist completo, upload de documentos e formulários em português"
            descricao="Cada documento exigido, na ordem certa, com o formulário oficial preenchível em português. Assine para destravar este kit."
          >
            {conteudoKit}
          </PaywallGate>
        )}
