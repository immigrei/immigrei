...
export default function FormularioClient({ hasAccess }: { hasAccess: boolean }) {
  ...
  // Load saved draft merged with the profile prefill. Plano grátis não
  // precisa desse dado — a tela de teaser abaixo nem mostra o formulário.
  useEffect(() => {
    if (!form || !hasAccess) return;
      ...
      <AppShell>
        <div className="max-w-2xl mx-auto px-5 sm:px-6 py-8">
          ...
          <p className="text-ink-soft text-sm leading-relaxed mb-6">
            Preencha em português e exporte o {form.code} oficial pronto para assinar — recurso exclusivo para
            assinantes.
          </p>
          <div className="bg-pine rounded-2xl px-5 py-5">
            ...
            <p className="text-sm font-semibold text-cream">
              Assine para preencher este formulário em português e exportar o {form.code} oficial.
            </p>
            <Link
              href="/planos"
