...
export default function CosB2F1Client({ hasAccess }: { hasAccess: boolean }) {
  const router = useRouter();

  // Plano grátis nem carrega o caso — evita 403 desnecessário e mostra o
  // teaser direto, sem flash de spinner.
        ...
        <div className="max-w-2xl mx-auto px-6 py-10">
          ...
          <div className="bg-pine rounded-2xl px-5 py-5">
            ...
            <p className="text-sm font-semibold text-cream">
              Assine para validar seu caso de mudança de status e ver os bloqueios, avisos e verificações que valem
              para você.
            </p>
            <Link
              href="/planos"
